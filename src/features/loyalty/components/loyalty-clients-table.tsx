            ...
            {filtered.map(client => {
              ...
              return (
                <div
                  key={client.id}
                  className={cn(
                    "grid grid-cols-[1fr_120px_100px_90px] gap-4 items-center bg-bg-sidebar border-[0.5px] border-border-main rounded-[9px] py-[14px] px-[18px] group hover:bg-bg-surface transition-all",
                ...
                >
                    ...
                    <div className="h-[4px] bg-bg-sidebar rounded-full overflow-hidden border-[0.5px] border-border-main">
                      <div
                        className={cn(
                          ...
                          client.ready ? "bg-accent-main" : "bg-[#333]"
                        )}
                  ...
                  <div className="text-center">
                    <span className={cn(
                      ...
                      client.ready ? "text-accent-main" : "text-[#333]"
                    )}>
