...
export function LoyaltyPageClient({ config, balance, history, clientId }: LoyaltyPageClientProps) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      {/* Header */}
      <div>
        <h1 className="text-4xl font-bold font-syne text-white tracking-tight">Minha Fidelidade</h1>
      ...
      <div className="bg-white/[0.03] border border-white/10 rounded-[2rem] p-6 md:p-8 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-bold font-syne text-white">Seu Cartão Fidelidade</h2>
        ...
        {isReady && (
          <div className="mt-6">
            <Button
              ...
              className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white font-bold gap-3 rounded-2xl py-7 text-base shadow-lg shadow-green-500/20 animate-pulse hover:animate-none"
            >
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-5 text-center">
          ...
          <p className="text-xl font-bold text-white font-syne">{totalEarned}</p>
      ...
      <div className="bg-white/[0.03] border border-white/10 rounded-[2rem] p-6 md:p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-lg font-bold font-syne text-white">Histórico</h2>
        </div>
