    ...
    <div className="space-y-[4px]">
      {members.map((member) => {
        ...
        return (
          <div 
            key={member.id} 
            className="grid grid-cols-[2fr_1.2fr_80px_60px_100px_80px_70px] gap-[12px] items-center bg-bg-sidebar border-[0.5px] border-border-main rounded-[9px] py-[13px] px-[18px] group hover:bg-bg-surface transition-all"
          >
            {/* Nome + Avatar */}
